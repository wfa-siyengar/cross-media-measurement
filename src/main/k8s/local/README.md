...
`//src/test/kotlin/org/wfanet/measurement/integration/k8s:LocalClusterCorrectnessTest`
...
One way to create a local cluster with a local private registry is to use
[KinD](https://kind.sigs.k8s.io/). Simply follow the
