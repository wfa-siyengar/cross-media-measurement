...
/**
 * Test for correctness of the CMMS on a single Kubernetes cluster using the `local` configuration.
 *
...
class LocalClusterCorrectnessTest : AbstractCorrectnessTest(measurementSystem) {
